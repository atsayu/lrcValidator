    ...
    for (var i = 0, length = lines.length; i < length; i += 1) {
        ...
        if (metadataMatch !== null) {
            ...
            var metadataLine = {
                lineNumber: i,
                raw: raw,
                type: exports.LineType.METADATA,
                key: key,
                value: value,
            };
...
function parseEnhanced(lrc) {
    ...
    return lines.map(function (line) {
        if (line.type === exports.LineType.LYRIC) {
            var words = [];
            ...
            return __assign(__assign({}, line), { type: exports.LineType.ENHANCED_LYRIC, words: words });
        }
        return line;
    });
}
...
exports.parse = parse;
exports.parseEnhanced = parseEnhanced;
